...
def parse_args():
    ...
    parser.add_argument("--image_dir",default='./12.jpg', type=str)
    parser.add_argument("--det_algorithm", type=str, default='DB')
    parser.add_argument("--det_model_dir",default='./ch_ppocr_server_v2.0_det_infer/', type=str)
    ...
    parser.add_argument("--rec_model_dir",default='./ch_ppocr_server_v2.0_rec_infer/', type=str)
    ...
    parser.add_argument("--cls_model_dir",default='./ch_ppocr_mobile_v2.0_cls_infer/', type=str)
